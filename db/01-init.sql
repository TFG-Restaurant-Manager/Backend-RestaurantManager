...
-- ORDER STATUS
-- =========================================
CREATE TYPE order_status AS ENUM ('CREATED', 'COOKED', 'DELIVERED', 'PAID');
...
-- 	d.restaurant_id
-- FROM dishes d
-- JOIN dishes_categories c on d.category_id = c.id;
...
-- LEFT JOIN dishes_categories c ON d.category_id = c.id;
